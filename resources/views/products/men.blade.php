...
<style>
    ...
    .product-card h3 { padding: 15px 20px 10px; font-size: 18px; font-weight: 600; color: #333; }
    .product-card p { padding: 0 20px; color: #666; font-size: 14px; margin-bottom: 15px; }
    .price { padding: 0 20px; font-size: 20px; font-weight: 700; color: #d32f2f; margin-bottom: 15px; }
    .product-card .btn { margin: 0 10px 15px; padding: 10px 20px; border-radius: 5px; font-weight: 600; text-decoration: none; display: inline-block; }
